...
<CodeBlock code={
    ...
    for (const promiseFunc of promisifiedFuncs) {
        // It's very interesting how this line works inside a for of loop
        // For this, you need to know Event loop and Micro task queue

        // In short, all the promises are chained in "promise" and
        // are executed together at the end
