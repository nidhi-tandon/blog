...
Bringing in more users to use the product is every company’s goal because it drives revenue. The meaning of a user varies from company to company. For SaaS companies like AWS, the developers are the users and for product companies, like Razorpay, end customers are the users. Let’s take the example of Razorpay. For Razorpay’s payment gateway team, the [merchants](https://en.wikipedia.org/wiki/Merchant) who opt for Razorpay’s Payment Gateway are the users. So, the company tries to bring in more users by solving their payment problems, and providing a better payment solution is company’s one of many products.
...
In the case of Razorpay, the user’s journey begins by searching the payment gateway in a browser. An interested user would click on this link and land on their [website](https://razorpay.com).
...
Once a user finds Razorpay via a search engine or advertisement etc. and lands on the brand [website](https://razorpay.com), we can proudly say that we have reached the first step to convince the user to buy our product, and when they buy our product, they will be converted to our customer. In our words, we could say [conversion](https://support.google.com/analytics/answer/6086209?hl=en) is done for the user.
...
- The user could be coming from [advertisements](https://ads.google.com/intl/en_in/home/) and [campaigns](https://support.google.com/google-ads/answer/6304?hl=en) running on LinkedIn, Facebook, Twitter, or any other social platform. We will call it a **social user**.
...
- A user may have heard about Razorpay and directly searched it on a search engine and landed on [razorpay.com](http://razorpay.com). We will call it an **organic user**.

- A user may have the link to the [razorpay.com](https://razorpay.com) website and directly landed on the website. We will call it a **direct user**
...
<div className={styles.bonus}>
    ...
    > You can check out [Google Optimize](https://marketingplatform.google.com/about/optimize/), [Optimizely](https://www.optimizely.com/products/intelligence/web-experimentation/), or any client-side A/B experiment tool for this.
...
When these events are accumulated in a meaningful way, it could be called a [metric](https://support.optimizely.com/hc/en-us/articles/4410289407885). We can then create our entire [funnel](https://www.optimizesmart.com/the-geek-guide-to-understanding-funnels-in-google-analytics/#0-introduction-to-funnels-in-google-analytics) through the metrics data and after accumulating the data over a period of time and visualizing it in the form of a graph, a winner can be chosen.
...
- Understanding [SEO](https://www.searchenginejournal.com/why-seo-is-important-for-business/248101/) as SEO will make your company visible and can bring in more users
...
- Thinking about observability and [operational excellence](https://www.iteratorshq.com/blog/ultimate-guide-to-operational-excellence/). This involves thinking in terms of
    - Tracking of Metrics
...
<div className={styles.linkSection}>
  Links for reference: 1. Definition of
  [Merchant](https://en.wikipedia.org/wiki/Merchant) 2. Definition of
  [Conversion](https://support.google.com/analytics/answer/6086209?hl=en) 3.
  What are [Google Ads](https://ads.google.com/intl/en_in/home/)? 4. Definition
  of [Campaign](https://ads.google.com/intl/en_in/home/) 5. What are [A/B
  experiments](https://www.optimizely.com/optimization-glossary/ab-testing/)? 6.
  Feature
  [rollout](https://www.optimizely.com/optimization-glossary/feature-rollout/#:~:text=A%20feature%20rollout%20is%20the,bundled%20together%2C%20and%20then%20monitored.)
  7. [Google optimize](https://marketingplatform.google.com/about/optimize/) 8.
  [Optimizely](https://www.optimizely.com/products/intelligence/web-experimentation/)
  9. [Metrics](https://support.optimizely.com/hc/en-us/articles/4410289407885)
  in Optmizely 10. Introduction to
  [Funnels](https://www.optimizesmart.com/the-geek-guide-to-understanding-funnels-in-google-analytics/#0-introduction-to-funnels-in-google-analytics)
  11. Why
  [SEO](https://www.searchenginejournal.com/why-seo-is-important-for-business/248101/)
  is important? 12. [Operational
  Excellence](https://www.iteratorshq.com/blog/ultimate-guide-to-operational-excellence/)
  13. Bonus: [The Event Segmentation chart: an overview –
  Amplitude](https://help.amplitude.com/hc/en-us/articles/360033852251-The-Event-Segmentation-chart-an-overview?wvideo=i4dgi1oxd3)
</div>
